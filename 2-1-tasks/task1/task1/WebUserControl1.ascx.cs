...
namespace task1
{
    public partial class WebUserControl1 : System.Web.UI.UserControl
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            //results.Visible = true;
            //radio.Visible = false;
            SqlConnection con2 = new SqlConnection("data source= DESKTOP-EJ4EJ89\\SQLEXPRESS; database=task-2-jan; integrated security=SSPI");
            SqlCommand cmd = new SqlCommand("select * from vote", con2);
            con2.Open();
            SqlDataReader sdr = cmd.ExecuteReader();
            double excellent = 0;
            double vgood = 0;
